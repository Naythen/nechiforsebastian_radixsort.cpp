// Radix Sort: still in progress... ( sortarea numerelor prin metoda radix sort )
#include<iostream>
using namespace std;
int M[100];
int n;
...
int read_data()
{
  cout<<"Cate numere doriti sa introduceti?"<<endl;cin>>n;
  for(int i=1;i<=n;i++)
  {
      cout<<"M["<<i<<"]=";
      cin>>M[i];
...
for(int i=1;i<=n;i++)
 cout<<M[i]<<"; ";
 cout<<endl<<"Numerele au fost sortate!";
}
